...
dependencies {
    // all modules
    implementation("io.asteroid.ldk:all:1.0.2")

    // common module
    implementation("io.asteroid.ldk:common:1.0.2")

    // license module
    implementation("io.asteroid.ldk:license:1.0.2")

    // obfuscate module
    implementation("io.asteroid.ldk:obfuscate:1.0.2")
}
```
